...
'Descuento 1': 'Descuento 1',
'Descuento 2': 'Descuento 2',
'design': 'modificar',
'DESIGN': 'DISEÑO',
...
'includes': 'incluye',
'Index': 'Indice',
'Ingreso Bono': 'Ingreso Bono',
'Ingreso Comision': 'Ingreso Comision',
'Ingreso Fijo': 'Ingreso Fijo',
'Ingreso Otros': 'Ingreso Otros',
...
'T datos archives': 'T datos archives',
'T datoses': 'T datoses',
'T departamentos archives': 'T departamentos archives',
'T departamentoses': 'T departamentoses',
'T empresas archives': 'T empresas archives',
'T empresases': 'T empresases',
'T estados archives': 'T estados archives',
'T estadoses': 'T estadoses',
'T niveles archives': 'T niveles archives',
'T niveleses': 'T niveleses',
'T nomina1a archives': 'T nomina1a archives',
'T nomina1a archives(f_clave_noi)': 'T nomina1a archives(f_clave_noi)',
'T nomina1a archives(f_departamento)': 'T nomina1a archives(f_departamento)',
'T nomina1a archives(f_empresa)': 'T nomina1a archives(f_empresa)',
'T nomina1a archives(f_fijo_15d)': 'T nomina1a archives(f_fijo_15d)',
'T nomina1a archives(f_nivel)': 'T nomina1a archives(f_nivel)',
'T nomina1a archives(f_nombre)': 'T nomina1a archives(f_nombre)',
'T nomina1a archives(f_puesto)': 'T nomina1a archives(f_puesto)',
'T nomina1a archives(f_sucursal)': 'T nomina1a archives(f_sucursal)',
'T nomina1as': 'T nomina1as',
'T nomina1as(f_clave_noi)': 'T nomina1as(f_clave_noi)',
'T nomina1as(f_departamento)': 'T nomina1as(f_departamento)',
'T nomina1as(f_empresa)': 'T nomina1as(f_empresa)',
'T nomina1as(f_fijo_15d)': 'T nomina1as(f_fijo_15d)',
'T nomina1as(f_nivel)': 'T nomina1as(f_nivel)',
'T nomina1as(f_nombre)': 'T nomina1as(f_nombre)',
'T nomina1as(f_puesto)': 'T nomina1as(f_puesto)',
'T nomina1as(f_sucursal)': 'T nomina1as(f_sucursal)',
'T puestos archives': 'T puestos archives',
'T puestoses': 'T puestoses',
'T sucursales archives': 'T sucursales archives',
'T sucursaleses': 'T sucursaleses',
'Table': 'tabla',
